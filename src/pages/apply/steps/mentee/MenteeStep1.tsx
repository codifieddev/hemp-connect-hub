...
import { COMPANY_TYPES, REFERRAL_SOURCES, INDUSTRIES } from '@/data/applicationData';
...
export const MenteeStep1: React.FC<MenteeStep1Props> = ({ form }) => {
  return (
    <div className="space-y-8">
      <FormSection title="Applicant Information" description="Tell us about yourself">
        <FieldRow columns={2}>
          <FormField
